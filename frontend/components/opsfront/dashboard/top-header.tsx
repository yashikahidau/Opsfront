    ...
    {user?.userType === "customer"
      ...
      : "Internal Support Operations"}
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <div className="hidden lg:flex items-center gap-3 rounded-2xl border border-border bg-card/50 px-3 py-2.5">
          ...
          <div className="grid size-10 place-items-center rounded-full bg-primary/10 text-sm font-semibold text-primary lg:hidden">
  {initials}
</div>
        </div>
      </div>
